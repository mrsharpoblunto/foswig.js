...
/**
 * @private
 * The max number of times to try and generate a word matching the given parameters
 * to the generateWord function before giving up
 */
var MAX_ATTEMPTS = 25;
 ...
 */
module.exports.prototype.generateWord = function(minLength,maxLength,allowDuplicates) {
	...
	while (repeat || (!allowDuplicates && ++attempts < MAX_ATTEMPTS && isDuplicate(word,this.duplicates)));
